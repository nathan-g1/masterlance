module.exports = function (app) {
  ...
  const createOwnerResolver = (userModelName) => function (role, context, cb) {
    if (context.modelName !== userModelName) { return process.nextTick(() => cb(null, false)) }
  ...
  Role.registerResolver('theClient', createOwnerResolver('Client'))
  Role.registerResolver('theFreelancer', createOwnerResolver('Freelancer'))
}
